...
template <> constexpr inline auto Calculator::qt_create_metaobjectdata<qt_meta_tag_ZN10CalculatorE_t>()
{
    ...
    QtMocHelpers::UintData qt_properties {
        // property 'display'
        QtMocHelpers::PropertyData<QString>(8, QMetaType::QString, QMC::DefaultPropertyFlags | QMC::Final, 0),
        // property 'expression'
        QtMocHelpers::PropertyData<QString>(9, QMetaType::QString, QMC::DefaultPropertyFlags | QMC::Final, 1),
        // property 'errorMessage'
        QtMocHelpers::PropertyData<QString>(10, QMetaType::QString, QMC::DefaultPropertyFlags | QMC::Final, 2),
    };
...
void Calculator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->pressButton((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Calculator::*)()>(_a, &Calculator::displayChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Calculator::*)()>(_a, &Calculator::expressionChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Calculator::*)()>(_a, &Calculator::errorMessageChanged, 2))
            return;
    }
...
// SIGNAL 1
void Calculator::expressionChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Calculator::errorMessageChanged()
{
